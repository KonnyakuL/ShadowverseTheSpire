...
public class Test_Common_Attack3_Necromancer extends CustomCard {
    private static final CardStrings CARDSTRINGS = CardCrawlGame.languagePack.getCardStrings("SvTS:Test_Common_Attack3_Necromancer");

    public static final String ID = "SvTS:Test_Common_Attack3_Necromancer";
    ...
    public Test_Common_Attack3_Necromancer(){
    ...
    public AbstractCard makeCopy(){
        return new Test_Common_Attack3_Necromancer();
    }
