...
public class Test_Rare_Attack_Necromancer extends CustomCard {
    private static final CardStrings CARDSTRINGS = CardCrawlGame.languagePack.getCardStrings("SvTS:Test_Rare_Attack_Necromancer");

    public static final String ID = "SvTS:Test_Rare_Attack_Necromancer";
    ...
    public Test_Rare_Attack_Necromancer(){
    ...
    public AbstractCard makeCopy(){
        return new Test_Rare_Attack_Necromancer();
    }
