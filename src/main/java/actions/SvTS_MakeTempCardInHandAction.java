...
public class SvTS_MakeTempCardInHandAction extends AbstractGameAction {
    private AbstractCard c;
    private static final float PADDING;
    private boolean isOtherCardInCenter;
    private boolean sameUUID;

    public SvTS_MakeTempCardInHandAction(AbstractCard card, boolean isOtherCardInCenter) {
    ...
    public SvTS_MakeTempCardInHandAction(AbstractCard card) {
        this(card, 1);
    }

    public SvTS_MakeTempCardInHandAction(AbstractCard card, int amount) {
        this.isOtherCardInCenter = true;
        this.sameUUID = false;
        UnlockTracker.markCardAsSeen(card.cardID);
        this.amount = amount;
    ...
    public SvTS_MakeTempCardInHandAction(AbstractCard card, int amount, boolean isOtherCardInCenter) {
        this(card, amount);
        this.isOtherCardInCenter = isOtherCardInCenter;
    }

    public SvTS_MakeTempCardInHandAction(AbstractCard card, boolean isOtherCardInCenter, boolean sameUUID) {
        this(card, 1);
        this.isOtherCardInCenter = isOtherCardInCenter;
    ...
    private void addToDiscard(int discardAmt) {
        ...
        addToBot(new BanishBeforeDiscarding(AbstractDungeon.player.discardPile));
    }
